...
/**
 * @file plugins/themes/default/CompendiumThemeThemePlugin.inc.php
 *
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * @class CompendiumThemeThemePlugin
 * @ingroup plugins_themes_compendium
 *
 * @brief Default theme
 */

import('lib.pkp.classes.plugins.ThemePlugin');
class CompendiumThemePlugin extends ThemePlugin {
	/**
	...
	public function init() {
		...
		$this->addStyle('base', 'styles/base.css');
	...
	function getDisplayName() {
		return __('plugins.themes.compendium.name');
	}
	...
	function getDescription() {
		return __('plugins.themes.compendium.description');
	}
}
